...
export default function Header() {
  ...
  return (
    <div className="flex items-center justify-between border-b border-zinc-200 p-1.5 dark:border-zinc-700">
      <div className="flex items-center px-2.5">
        ...
        <Link 
          href="/new"
          className="cursor-pointer rounded-xl px-2 py-1 text-sm dark:text-zinc-400">
          new
        </Link>
        {/* <span className="cursor-pointer rounded-xl px-2 py-1 text-sm hover:bg-zinc-100 dark:text-zinc-400 hover:dark:bg-zinc-700"> */}
        {/*   top */}
        {/* </span> */}
        <PostFilter />
      </div>
